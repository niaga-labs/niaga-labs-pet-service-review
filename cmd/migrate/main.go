// Command migrate applies the SQL migrations in ./migrations to the review
// database and exits.
//
...
import (
	...
	svcconfig "github.com/niaga-labs/niaga-labs-pet-service-review/internal/config"
	"go.uber.org/zap"
)
...
func main() {
	...
	zapLogger, err := logger.NewNamed(cfg.AppEnv, "service-review-migrate")
	if err != nil {
